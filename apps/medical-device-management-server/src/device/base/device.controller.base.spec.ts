  ...
  test("POST /devices", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        manufactureDate: CREATE_RESULT.manufactureDate.toISOString(),
      ...
      .expect([
        {
          ...
          manufactureDate: FIND_MANY_RESULT[0].manufactureDate.toISOString(),
  ...
  test("GET /devices/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        manufactureDate: FIND_ONE_RESULT.manufactureDate.toISOString(),
